...
class WorkThread(QThread):
    ...
    def select_channel(self, index):
        ...
        self.led_7.value = gpio_sta[0]
        self.led_11.value = gpio_sta[1]
        self.led_12.value = gpio_sta[2]
        print(f"Selected channel {index}: GPIO state {gpio_sta}")
    ...
    def run(self):
        global picam2
        # picam2 = Picamera2()
        # picam2.configure( picam2.still_configuration(main={"size": (320, 240),"format": "BGR888"},buffer_count=4))
